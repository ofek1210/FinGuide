...
import "../components/welcome/welcome-back.css";
          ...
          <div className="welcome-back-grid">
            <div className="welcome-back-content">
              <span className="welcome-back-eyebrow">
                <span aria-hidden="true">👋</span> טוב לראות אותך שוב
              </span>
              ...
              <p className="welcome-back-sub">שמחים שחזרת.</p>
              <p className="welcome-back-body">
                כל ביקור כאן הוא עוד צעד קטן לעבר עתיד פיננסי בטוח יותר.
              </p>
              <blockquote className="welcome-back-quote">
                <p>
                  ביטחון פיננסי לא נבנה ביום אחד — הוא נבנה החלטה חכמה אחת בכל
                  פעם.
                </p>
              </blockquote>
              ...
              >
                {isLeaving ? (
                  ...
                  <>
                    <span>המשך לדף הבית</span>
                    <span className="welcome-back-cta-arrow" aria-hidden="true">
                      ←
                    </span>
                  </>
                )}
            ...
            <figure className="welcome-back-portrait">
