...
function buildEnhancedSystemPrompt(userContext, profile, insights, recommendations) {
  const lines = [
    ...
    'ענה בעברית בצורה ברורה, מפורטת ומועילה.',
    '',
    'יש לך שתי יכולות:',
    '1. שאלות אישיות — ענה על סמך נתוני המשתמש המצורפים.',
    '2. שאלות כלליות על פיננסים, ביטוח ופנסיה בישראל — ענה על פי הידע הכללי המפורט להלן.',
    '',
    'כאשר עונים על שאלות כלליות:',
    '- תן הסבר מפורט ומובן לקורא הדיוט',
    '- כלול יתרונות וחסרונות כשרלוונטי',
    '- ציין טווחי מחירים/ממוצעים מהשוק הישראלי',
    '- הסבר מה מחייב חוקית ומה רשות',
    '- אל תמציא נתונים אישיים — אם חסרים, ציין זאת',
    '',
