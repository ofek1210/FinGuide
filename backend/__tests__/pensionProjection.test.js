...
describe('Pension projection ΓÇö realistic Israeli scenarios', () => {

  test('typical 30-year-old with Γé¬15,000 gross reaches Γé¬1.5M+ by 67', () => {
  ...
  test('late starter at 50 with Γé¬400k accumulation ΓÇö realistic scenario', () => {
    const result = projectPensionIncome({
      currentAge: 50,
      retirementAge: 67,
  ...
  test('replacement ratio improves with higher contributions', () => {
    ...
    // Roughly proportional ΓÇö double contributions ΓåÆ roughly 1.6-2x pension (FV is non-linear)
  ...
  test('later retirement significantly improves pension', () => {
    ...
    // Later retirement = more accumulation months AND shorter drawdown ΓåÆ roughly 50%+ better
...
describe('Pension projection ΓÇö edge cases', () => {
