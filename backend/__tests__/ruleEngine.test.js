...
describe('runPensionGapRules', () => {
  test('returns hasPensionGap and missingRoles for null analysisData', () => {
    ...
    // fundSectionDetected will be false → no gap
...
describe('runInsuranceDuplicateRules', () => {
  test('detects duplicate life insurance policies', () => {
    const policies = [
      { type: 'life', monthlyPremium: 200, provider: 'הראל' },
      { type: 'life', monthlyPremium: 180, provider: 'מנורה' },
      { type: 'health', monthlyPremium: 150, provider: 'מכבי' },
    ];
