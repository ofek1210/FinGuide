...
const bituahNetFundSchema = new mongoose.Schema(
  {
    ...
    POLICY_GENERATION: { type: String, default: '' },
    ...
    NET_DOMAIN: { type: String, default: 'bituah' },
    syncedAt: { type: Date, default: Date.now },
    raw: { type: mongoose.Schema.Types.Mixed, select: false },
  },
  { collection: 'bituahnet_funds', timestamps: false },
);

bituahNetFundSchema.index({ TSUA_SHNATIT_MEMUZAAT_5_SHANIM: -1 });

module.exports = mongoose.model('BituahNetFund', bituahNetFundSchema);
