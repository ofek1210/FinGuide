...
- [ ] **3.1** דף ממצאים – קיבוץ לפי severity, חיפוש ב־title/details, כפתור "למסמכים".
- [ ] **3.2** עוזר AI – היסטוריית שיחה (sessionStorage/localStorage), הצגת model, כפתור "העתק תשובה".

---

## עדיפות 4 – פרופיל, עזרה, נגישות

- [ ] **4.1** פרופיל ו־Avatar – חיבור כשהבאק יספק PATCH /api/auth/me ו־Avatar.
- [ ] **4.2** דפי עזרה / סטטוס / אינטגרציות – השלמת תוכן סטטי בעברית.
- [ ] **4.3** RTL ונגישות – וידוא dir="rtl", labels, aria-labels, ניווט מקלדת.
